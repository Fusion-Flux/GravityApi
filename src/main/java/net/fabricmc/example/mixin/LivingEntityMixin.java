...
public abstract class LivingEntityMixin extends Entity {
    ...
    public void travel(Vec3d movementInput) {
        if (this.canMoveVoluntarily() || this.isLogicalSideForUpdatingMovement()) {
            ...
            if (this.isTouchingWater() && this.shouldSwimInFluids() && !this.canWalkOnFluid(fluidState.getFluid())) {
                ...
                BlockPos blockPos = new BlockPos(this.getPos().x, this.getPos().y, this.getBoundingBox().minZ - 0.5000001D);//change
    ...
    public void tickMovement() {
        ...
        this.travel(new Vec3d((double)this.sidewaysSpeed, (double)this.forwardSpeed, (double)this.upwardSpeed));
        this.world.getProfiler().pop();
